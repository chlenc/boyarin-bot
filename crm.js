                        ...
                        if(data[j].date == date) {
                            ...
                            for(var i = 0; i< schedule.length; i=i+4){
                                ...
                                if(schedule[i] != undefined)
                                    temp.push({text: (schedule[i]+'').substring(0, 2) + ':' + (schedule[i]+'').substring(2), callback_data:'mdt&&'+name+'&&'+date+'&&'+schedule[i]+'&&'+id});
                                if(schedule[i+1] != undefined)
                                    temp.push({text: (schedule[i+1]+'').substring(0, 2)+':'+(schedule[i+1]+'').substring(2),callback_data:'mdt&&'+name+'&&'+date+'&&'+schedule[i+1]+'&&'+id});
                                if(schedule[i+2] != undefined)
                                    temp.push({text: (schedule[i+2]+'').substring(0, 2)+':'+(schedule[i+2]+'').substring(2),callback_data:'mdt&&'+name+'&&'+date+'&&'+schedule[i+2]+'&&'+id});
                                if(schedule[i+3] != undefined)
                                    temp.push({text: (schedule[i+3]+'').substring(0, 2)+':'+(schedule[i+3]+'').substring(2),callback_data:'mdt&&'+name+'&&'+date+'&&'+schedule[i+3]+'&&'+id});
                                key.push(temp)
                            }
